...
export default function PetProfile(props) {
  ...
  const buttonThreeEightFourEightFourFourThreeFourOnClick = async () => {
  ...
  return (
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeEightFourEightFourFourThreeFourOnClick();
        }}
        {...getOverrideProps(overrides, "Button38484434")}
      ></Button>
      <Image
        width="160px"
        height="160px"
      ...
      >
        ...
        <Button
          ...
          variation="primary"
          children="Update"
          {...getOverrideProps(overrides, "Button38484350")}
        ></Button>
      </Flex>
    </Flex>
  );
